...
public class BookEntity extends AbstractEntity {
  ...
  public static class BookEntityBuilder<B> implements GenericBuilder<B>, BuilderWithId<BookEntity> {
    protected BookEntityBuilder() {}

    @Override
    public BookEntity buildWithId() {
      return BuilderWithId.super.buildWithId();
    }

    @Override
    public BookEntity buildInternally(final boolean generateId) {
