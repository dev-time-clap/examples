...
public class CustomerEntity extends AbstractEntity {
  ...
  public static class CustomerEntityBuilder<B> implements GenericBuilder<B>, BuilderWithId<CustomerEntity> {
    ...
    @Override
    public CustomerEntity buildInternally(final boolean generateId) {
