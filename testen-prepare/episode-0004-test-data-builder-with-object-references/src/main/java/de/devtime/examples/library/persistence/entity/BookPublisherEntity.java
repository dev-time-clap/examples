...
public class BookPublisherEntity extends AbstractEntity {
  ...
  public static class BookPublisherEntityBuilder<B> implements GenericBuilder<B>, BuilderWithId<BookPublisherEntity> {
    ...
    @Override
    public BookPublisherEntity buildInternally(final boolean generateId) {
