...
public class AuthorEntity extends AbstractEntity {
  ...
  public static class AuthorEntityBuilder<B> implements GenericBuilder<B>, BuilderWithId<AuthorEntity> {
    ...
    @Override
    public AuthorEntity buildInternally(final boolean generateId) {
